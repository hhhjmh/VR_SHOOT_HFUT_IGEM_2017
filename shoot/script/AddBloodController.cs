...
public class AddBloodController : MonoBehaviour
{
    ...
    void Update()
    {
        if (Controller.gamebegin && CanAddBlood)
        {
    ...
    private void InitPerb()
    {
        ...
        foreach (var a in perba)
        {
            ...
            obj.GetComponent<AddBlood>().per = 20f;
            obj.GetComponent<AddBlood>().life = 10f;
        }
    }
}